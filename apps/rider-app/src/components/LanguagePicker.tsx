 ...
 * language context. Used on registration and the Home tab. Selecting a language
 * switches it app-wide immediately (and persists it). `compact` shrinks it for
 * inline placement (e.g. atop the Home screen).
 */
export function LanguagePicker({ label, compact }: { label?: string; compact?: boolean }) {
...
const styles = StyleSheet.create({
  ...
  optionCompact: { paddingVertical: theme.space.xs },
