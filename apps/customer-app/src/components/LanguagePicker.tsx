 ...
 * language context. Used on onboarding and in the profile. Selecting a language
 * switches it app-wide immediately (and persists it).
 */
...
const styles = StyleSheet.create({
  ...
  optionActive: { backgroundColor: theme.color.primary },
  optionText: { fontSize: theme.font.body, fontWeight: theme.weight.semibold, color: theme.color.textMuted },
